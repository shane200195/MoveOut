...
class CategoryModel:
    ...
    def __init__(self, files ):
        ...
        #print(self.mean_categories, self.var_categories)
    ...
    def normalise_customer(self, customer_value: np.array, i: int) -> np.array:
        mu, var = self.mean_categories[i, :], self.var_categories[i, :]
    ...
    def change_normalise_customer_category(self, normed_customer: np.array, new_i: int) -> np.array:
        mu, var = self.mean_categories[new_i, :], self.var_categories[new_i, :]
